...
df_train_integer$Mystery <- as.numeric(gsub('M', '', df_train_integer$Mystery))
df_train_integer$Mystery <- factor(df_train_integer$Mystery, ordered = T)# as.numeric(factor(data_train$Mystery, levels = c('M1', 'M2', 'M3', 'M4', 'M5', 'M6', 'M7', 'M8', 'M9', 'M10', 'M11', 'M12', 'M13', 'M14', 'M15', 'M16', 'M17', 'M18', 'M19', 'M20'), ordered = T))
```
