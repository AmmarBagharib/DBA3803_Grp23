...
Industry_6 <- c(34, 43, 17, 44, 12, 8)
getcvplot(Industry_6, 20220103)


# Sampling for 24 industry
# N_industry = sample(c(2:49), 24) - the selected 24 industries based on random sampling.
Industry_24 <- c(42, 22, 41, 2, 26, 3, 10, 33, 48, 5, 32, 21, 44, 12, 6, 20, 34, 38, 8, 16, 37, 29, 31, 30)
getcvplot(Industry_24, 20220103)

#48 industries - using all 48 industries so don't require sampling
Industry_48 <- c(2:49)
...
N_industry = c(34, 43, 17, 44, 12, 8) #selected 6 industries based on random sampling.
columns <- colnames(data)[c(1, N_industry)] # Take out the 6 columns of the chosen industry
...
layout(matrix(c(1,2), 2, 2, byrow = TRUE))
plot1 <- plot(lasso, sign.lambda = -1, main = paste(n_select, "Industries in Lasso"))
plot2 <- plot(ridge, sign.lambda = -1, main = paste(n_select, "Industries in Ridge"))
